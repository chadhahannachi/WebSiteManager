...
// import NewsStyleOne from './NewsStyleOne';
// import NewsStyleTwo from './NewsStyleTwo';
// import NewsStyleThree from './NewsStyleThree';

// const styles = [
//   { name: 'Grid with Buttons', component: NewsStyleOne },
//   { name: 'Icon Cards', component: NewsStyleTwo },
//   { name: 'Scrollable Cards', component: NewsStyleThree },
// ];
...
//     desc: 'Enhance your interactions and improve customer relationships by creating your website or online portal.',
//   },
//   {
//     name: 'TMA & IT Outsourcing',
//     icon: 'EqualizerIcon',
//     desc: 'We are your partner in your digital strategy, and in maintaining your solutions up-to-date and running smoothly as well as performing optimally.',
//   },
//   {
//     name: 'Business Intelligence',
//     icon: 'SchoolIcon',
//     desc: "We collect your data through your information system (IS) in order to measure the performance of your activities through reports and dashboards, enabling you to make the right decisions!",
//   },
//   {
//     name: 'Business Intelligence',
//     icon: 'SchoolIcon',
...
//   const NewsComponent = styles[styleIndex].component;

//   return (
//     <section className="news">
//       <div className="news-header">
//         <h1>Latest News</h1>
//         <div className="news-style-switcher">
//           <button
//             className="menu-icon"
//             onClick={() => setMenuOpen(!menuOpen)}
//             aria-label="Change News style"
//           >
...
export default function News({ styleIndex }) {
...
//   // Appeler fetchNews une fois que userEntreprise est défini
//   useEffect(() => {
//     if (userEntreprise) {
//       fetchNews();
//     }
