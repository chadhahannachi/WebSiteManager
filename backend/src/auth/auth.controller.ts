...
async getUserById(@Param('id') id: string) {
  ...
  @Get('/superAdminABshore')
  async getSuperAdminABshore(): Promise<User[]> {
    return this.authService.findSuperAdminABshore();
  }

  @Get('/SuperAdminEnt')
  async getSuperAdminEnt(): Promise<User[]> {
    return this.authService.findSuperAdminEnt();
  }


  @Get('/Moderateur')
  async getModerateurs(): Promise<User[]> {
    return this.authService.findModerateur();
  }
